...
public class EncryptUtils {
     ...
     * Encrypts the encrypted file according to the corresponding encryption algorithm, the specified key, return the source file
     *
     ...
     * @return
     */
    public static String encrypt(String Algorithm, String source, String key) throws Exception {
        // 判断Key是否正确
        if (key == null) {
     ...
     * @return String 加密后的字符串
     */
    public String encryptToSHA(String source) {
        byte[] digesta = null;
        try {
            // 得到一个SHA-1的消息摘要
